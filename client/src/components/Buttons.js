...
export const HeaderLinkButton = (props) => {
  return (
    <a
      className="mr-8 inline-block rounded bg-gray-200 px-6 py-4 text-center text-xl font-thin text-gray-800 shadow-md transition-colors duration-300 hover:bg-bruss hover:text-white"
